...
namespace ListenerX.Classes
{
    public sealed class AbstractKeyGrid : IEnumerable<IAbstractKey>
    {
        ...
        public AbstractKeyGrid(object[,] physicalGrid)
        {
...
#pragma warning disable CA1814 // Prefer jagged arrays over multidimensional
            var defaultGrid = new object[,]{
                            ...
                            { Key.Macro3,Key.CapsLock,Key.A,Key.S,Key.D,Key.F,Key.G,Key.H,Key.J,Key.K,Key.L,Key.OemSemicolon,Key.OemApostrophe, Key.Invalid,Key.Enter,Key.Invalid,Key.Invalid,Key.Invalid,Key.Num4,Key.Num5,Key.Num6,Key.Invalid ,GridLed.LeftSide4, Key.Invalid,Key.Invalid,GridLed.Backlight,Key.Invalid,Key.Invalid,GridLed.RightSide4},
                            { Key.Macro4,Key.LeftShift,Key.Invalid, Key.Z,Key.X,Key.C,Key.V,Key.B,Key.N,Key.M,Key.OemComma,Key.OemPeriod,Key.OemSlash,Key.Invalid, Key.RightShift, Key.Invalid,Key.Up,Key.Invalid,Key.Num1,Key.Num2,Key.Num3,Key.NumEnter,GridLed.LeftSide5, Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,GridLed.RightSide5},
                            {Key.Macro5, Key.LeftControl,Key.LeftWindows,Key.LeftAlt,Key.Invalid, Key.Invalid, Key.Invalid,Key.Space,Key.Invalid,Key.Invalid,Key.Invalid, Key.RightAlt,Key.Function,Key.RightMenu,Key.RightControl,Key.Left,Key.Down,Key.Right,Key.Invalid,Key.Num0,Key.NumDecimal,Key.Invalid,GridLed.LeftSide6, Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,GridLed.RightSide6 },
