...
#pragma warning disable CA1814 // Prefer jagged arrays over multidimensional
                var grid = new object[,]{
                            { Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,GridLed.LeftSide1, Key.Invalid,Key.Invalid, Key.Invalid,Key.Invalid,Key.Invalid,GridLed.RightSide1, Key.Invalid, MousepadLed.Led0, MousepadLed.Led1, MousepadLed.Led2, MousepadLed.Led3 }, //ghost row
                            { Key.Invalid, Key.Escape, Key.Invalid, Key.F1,Key.F2,Key.F3, Key.F4,Key.F5, Key.F6, Key.F7, Key.F8, Key.F9, Key.F10, Key.F11, Key.F12,Key.PrintScreen,Key.Scroll,Key.Pause, Key.Invalid,Key.Invalid,Key.Logo,Key.Invalid, GridLed.LeftSide2, Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid, GridLed.RightSide2,                                                Key.Invalid, MousepadLed.Led13,MousepadLed.Led14,Key.Invalid,         MousepadLed.Led4 },
                            { Key.Macro1, Key.OemTilde, Key.D1, Key.D2, Key.D3, Key.D4, Key.D5, Key.D6, Key.D7, Key.D8, Key.D9, Key.D0,Key.OemMinus, Key.OemEquals, Key.Backspace,Key.Insert,Key.Home,Key.PageUp,Key.NumLock,Key.NumDivide,Key.NumMultiply,Key.NumSubtract, GridLed.LeftSide3, Key.Invalid,Key.Invalid,GridLed.ScrollWheel,Key.Invalid,Key.Invalid,GridLed.RightSide3,                    Key.Invalid, MousepadLed.Led12,HeadsetLed.Led0,  HeadsetLed.Led1,  MousepadLed.Led5 },
                            { Key.Macro2,Key.Tab,Key.Q,Key.W,Key.E,Key.R,Key.T,Key.Y,Key.U,Key.I,Key.O,Key.P,Key.OemLeftBracket,Key.OemRightBracket,Key.OemBackslash, Key.Delete,Key.End,Key.PageDown,Key.Num7,Key.Num8,Key.Num9,Key.NumAdd, GridLed.LeftSide4, Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,GridLed.RightSide4,                                                           Key.Invalid, MousepadLed.Led11,Key.Invalid,         Key.Invalid,         MousepadLed.Led6 },
                            { Key.Macro3,Key.CapsLock,Key.A,Key.S,Key.D,Key.F,Key.G,Key.H,Key.J,Key.K,Key.L,Key.OemSemicolon,Key.OemApostrophe, Key.Invalid,Key.Enter,Key.Invalid,Key.Invalid,Key.Invalid,Key.Num4,Key.Num5,Key.Num6,Key.Invalid ,GridLed.LeftSide5, Key.Invalid,Key.Invalid,GridLed.Backlight,Key.Invalid,Key.Invalid,GridLed.RightSide5,                                                Key.Invalid, MousepadLed.Led10,MousepadLed.Led9, MousepadLed.Led8, MousepadLed.Led7 },
                            { Key.Macro4,Key.LeftShift,Key.Invalid, Key.Z,Key.X,Key.C,Key.V,Key.B,Key.N,Key.M,Key.OemComma,Key.OemPeriod,Key.OemSlash,Key.Invalid, Key.RightShift, Key.Invalid,Key.Up,Key.Invalid,Key.Num1,Key.Num2,Key.Num3,Key.NumEnter,GridLed.LeftSide6, Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,GridLed.RightSide6, Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid},
                            { Key.Macro5, Key.LeftControl,Key.LeftWindows,Key.LeftAlt,Key.Invalid, Key.Invalid, Key.Invalid,Key.Space,Key.Invalid,Key.Invalid,Key.Invalid, Key.RightAlt,Key.Function,Key.RightMenu,Key.RightControl,Key.Left,Key.Down,Key.Right,Key.Invalid,Key.Num0,Key.NumDecimal,Key.Invalid,GridLed.LeftSide7, Key.Invalid,Key.Invalid,GridLed.Logo,Key.Invalid,Key.Invalid,GridLed.RightSide7, ChromaLinkLed.LinkLed0,ChromaLinkLed.LinkLed1,ChromaLinkLed.LinkLed2,ChromaLinkLed.LinkLed3,ChromaLinkLed.LinkLed4 },
                        };
