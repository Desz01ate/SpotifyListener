...
#pragma warning disable CA1814 // Prefer jagged arrays over multidimensional
                var grid = new object[,]{
                            { Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,GridLed.LeftSide1, Key.Invalid,Key.Invalid, Key.Invalid,Key.Invalid,Key.Invalid,GridLed.RightSide1 }, //ghost row
                            ...
                            { Key.Macro4,Key.LeftShift,Key.Invalid, Key.Z,Key.X,Key.C,Key.V,Key.B,Key.N,Key.M,Key.OemComma,Key.OemPeriod,Key.OemSlash,Key.Invalid, Key.RightShift, Key.Invalid,Key.Up,Key.Invalid,Key.Num1,Key.Num2,Key.Num3,Key.NumEnter,GridLed.LeftSide6, Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,Key.Invalid,GridLed.RightSide6},
